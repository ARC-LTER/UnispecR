...
### Quality Check Unispec Key 

```{r missing, warnings=F}
### MISSING: Identify any measurement locations that are missing corresponding raw spu files. Lists missing raw .spu files OR extra .spu files that aren't accounted for in the unispec field keys. 
...
print(paste0("Unprocessed .spu files: ", length(unprocessed_files)))
```
