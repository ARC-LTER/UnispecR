...
xlsx_filename <- paste0("UnispecData/", dir_year, "_processed_xlsx_data.rds")
...
xlsx_keyname <- paste0("UnispecData/", dir_year, "_processed_xlsx_key.csv")
...
unispec_keyname <- paste0("UnispecData/", dir_year, "_unispec_key.csv") # manually updated key
...
## Which Date
check_dates <- c("2016-05-26") # necessary to unlist dates vector
...
unispec_problem_keyname <- paste0("UnispecData/", format(unispec_problem_key$Date[1], format="%Y"),"_unispec_key_problems.csv")
...
Full Unispec Problem Keys have been saved for the following years:
  ...
  - 2018 :
```{r}
key_filename <- paste0("UnispecData/", dir_year, "_unispec_key_problems.csv") # manually updated key
...
unispec_filename <- paste0("UnispecData/", format(unispec_data$DateTime[1], format="%Y"),"_unispec_data.rds")
...
```{r}
df <- read_rds("UnispecData/2015_unispec_dataframe.rds")
